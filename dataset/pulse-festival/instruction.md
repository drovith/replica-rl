...
- `index.html` — The Festival  (target: `design/index.png`)
- `lineup.html` — Lineup  (target: `design/lineup.png`)
- `schedule.html` — Schedule  (target: `design/schedule.png`)
- `tickets.html` — Tickets  (target: `design/tickets.png`)
- `travel.html` — Getting There  (target: `design/travel.png`)
