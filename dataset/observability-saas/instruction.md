...
- `platform.html` — Platform  (target: `design/platform.png`)
- `how-it-works.html` — How it works  (target: `design/how-it-works.png`)
- `integrations.html` — Integrations  (target: `design/integrations.png`)
- `pricing.html` — Pricing  (target: `design/pricing.png`)
- `changelog.html` — Changelog  (target: `design/changelog.png`)
