...
- `firm.html` — The Firm  (target: `design/firm.png`)
- `practices.html` — Practices  (target: `design/practices.png`)
- `attorneys.html` — Attorneys  (target: `design/attorneys.png`)
- `insights.html` — Insights  (target: `design/insights.png`)
