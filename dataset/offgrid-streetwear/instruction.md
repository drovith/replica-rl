...
- `index.html` — Index  (target: `design/index.png`)
- `manifesto.html` — Manifesto  (target: `design/manifesto.png`)
- `collection.html` — Collection  (target: `design/collection.png`)
- `product.html` — Product  (target: `design/product.png`)
- `drops.html` — Schedule  (target: `design/drops.png`)
- `stores.html` — Stores  (target: `design/stores.png`)
