...
- `ethos.html` — The Retreat  (target: `design/ethos.png`)
- `programs.html` — Programs  (target: `design/programs.png`)
- `space.html` — The Space  (target: `design/space.png`)
- `teachers.html` — Teachers  (target: `design/teachers.png`)
