...
- `research.html` — Research  (target: `design/research.png`)
- `people.html` — People  (target: `design/people.png`)
- `publications.html` — Publications  (target: `design/publications.png`)
- `join.html` — Join & Collaborate  (target: `design/join.png`)
